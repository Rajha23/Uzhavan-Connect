...
export const FarmerDashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div 
        onClick={() => setDrawerState({ type: 'ai-mentor' })}
        className="p-6 rounded-[28px] bg-[#eaf4ec]/90 border border-[#a3b18a]/50 shadow-soft flex flex-col md:flex-row md:items-center justify-between gap-5 relative overflow-hidden cursor-pointer hover:border-[#01472e]/50 transition-all group"
      >
        <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-[#ccd5ae]/20 blur-2xl pointer-events-none" />
        <div className="flex items-start gap-4 relative z-10">
          <div className="w-12 h-12 rounded-2xl bg-[#01472e] text-[#fefae0] flex items-center justify-center shadow-soft shrink-0 group-hover:scale-105 transition-transform">
        ...
        <div className="flex items-center gap-2 self-start md:self-center shrink-0 relative z-10">
          <button
            onClick={(e) => { e.stopPropagation(); setDrawerState({ type: 'ai-mentor' }); }}
            className="btn-primary text-xs px-5 py-2.5 shadow-soft"
          >
      ...
      <KPIGrid columns={4}>
        <KPIStatCard
          ...
          onClick={() => setDrawerState({ type: 'listed-volume' })}
        />
        ...
        <KPIStatCard
          ...
          onClick={() => setDrawerState({ type: 'buyer-demand' })}
        />
        ...
        <KPIStatCard
          ...
          subtitleColor="text-[#01472e]"
          onClick={() => setDrawerState({ type: 'payout-share' })}
        />
        ...
        <KPIStatCard
          ...
          onClick={() => setDrawerState({ type: 'cold-chain' })}
        />
      </KPIGrid>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#ccd5ae]/30 pb-4">
                    ...
                    <div className="flex items-center gap-3 self-start sm:self-auto">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#eaf4ec] hover:bg-[#01472e] text-[#01472e] hover:text-[#fefae0] text-xs font-semibold rounded-xl border border-[#a3b18a]/40 transition flex items-center gap-1.5 cursor-pointer shadow-2xs"
                        title="View Full Produce Listing Information"
                      >
