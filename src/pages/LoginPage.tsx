            ...
            <div>
              ...
              <div className="mt-6 pt-5 border-t border-[#ccd5ae]/40">
                ...
                <div className="grid grid-cols-3 gap-2 text-[11px]">
                  <button
                    type="button"
                    onClick={() => { setLoginRole('BULK_BUYER'); setIdentifier('vikram.procurement@metroagri.in'); setPassword('BulkBuyer@2026'); }}
                  ...
                  <button
                    type="button"
                    onClick={() => { setLoginRole('FARMER'); setIdentifier('rajesh.kumar@uzhavanconnect.gov.in'); setPassword('Farmer@2026'); }}
                    className="p-2.5 rounded-2xl bg-[#faf9f5] hover:bg-[#eaf4ec] text-[#01472e] border border-[#ccd5ae]/60 font-semibold transition text-center cursor-pointer flex flex-col items-center group shadow-2xs"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => { setLoginRole('RETAIL_BUYER'); setIdentifier('anita.procurement@abcretail.in'); setPassword('Buyer@2026'); }}
                    className="p-2.5 rounded-2xl bg-[#faf9f5] hover:bg-[#eaf4ec] text-[#01472e] border border-[#ccd5ae]/60 font-semibold transition text-center cursor-pointer flex flex-col items-center group shadow-2xs"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => { setLoginRole('FPO_AGGREGATOR'); setIdentifier('ravi.fpo@uzhavanconnect.gov.in'); setPassword('Fpo@2026'); }}
                    className="p-2.5 rounded-2xl bg-[#faf9f5] hover:bg-[#eaf4ec] text-[#01472e] border border-[#ccd5ae]/60 font-semibold transition text-center cursor-pointer flex flex-col items-center group shadow-2xs"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => { setLoginRole('LOGISTICS'); setIdentifier('dispatch@sundartrans.in'); setPassword('Logistics@2026'); }}
                    className="p-2.5 rounded-2xl bg-[#faf9f5] hover:bg-[#eaf4ec] text-[#01472e] border border-[#ccd5ae]/60 font-semibold transition text-center cursor-pointer flex flex-col items-center group shadow-2xs"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => { setLoginRole('ADMIN'); setIdentifier('admin@uzhavanconnect.gov.in'); setPassword('Admin@2026'); }}
                    className="p-2.5 rounded-2xl bg-[#faf9f5] hover:bg-[#eaf4ec] text-[#01472e] border border-[#ccd5ae]/60 font-semibold transition text-center cursor-pointer flex flex-col items-center group shadow-2xs"
                  >
