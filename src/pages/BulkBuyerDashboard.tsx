...
export const BulkBuyerDashboard: React.FC = () => {
  ...
  const fallbackShipment = INITIAL_ORDERS.find((o) => o.isBulkOrder) || INITIAL_ORDERS[0];
  const activeShipment = bulkOrders.find((o) => o.status === 'In Transit' || o.lifecycleStage === 'IN_TRANSIT') || bulkOrders[0] || orders[0] || fallbackShipment;
        ...
        <div className="space-y-8">
          ...
          <div className="agri-card rounded-[32px] p-6 sm:p-8 border border-[#ccd5ae]/40 shadow-soft">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[#01472e]/60 font-mono">
                    {t('common.order', 'Order')}: {activeShipment?.id || 'ORD-BULK-01'}
                  </span>
                </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => activeShipment?.batchId && openPassportModal(activeShipment.batchId)}
            ...
            <div className="lg:col-span-7 agri-card rounded-[32px] p-6 sm:p-7 border border-[#ccd5ae]/40 shadow-soft space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#01472e]/70">{t('bulkBuyer.contributingSuppliersSubtitle', 'Farmers & FPOs contributing to Order {id}', { id: activeShipment?.id || 'ORD-BULK-01' })}</p>
                </div>
          ...
          <div className="agri-card rounded-[32px] p-6 sm:p-8 border border-[#ccd5ae]/40 shadow-soft grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <div className="text-xs text-[#01472e]/80 space-y-1">
                ...
                <p><b>{t('bulkBuyer.totalWeight', 'Total Weight')}:</b> {activeShipment?.quantityKg ? activeShipment.quantityKg.toLocaleString() : '5,000'} kg (200 Crates)</p>
            ...
            <div className="space-y-2 flex flex-col justify-between">
              ...
              <div className="flex items-center gap-2 pt-2">
                <button
                  onClick={() => activeShipment && setSelectedOrderForDelivery(activeShipment)}
