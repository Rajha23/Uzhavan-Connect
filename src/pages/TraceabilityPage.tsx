        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 bg-[#fefae0]/15 border border-[#fefae0]/25 px-3 py-1 rounded-full text-xs font-semibold tracking-wide text-[#fefae0]">
              ...
              <span>Immutable Produce Provenance & Traceability Ledger</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">
              Produce Traceability & Passports
            </h1>
            <p className="text-sm text-emerald-100/80 mt-1 font-normal max-w-2xl">
              End-to-end farm-to-fork cryptographic ledger tracking harvest, grading lab tests, cold transit, and buyer delivery.
            </p>
          </div>
          <button
        ...
        <div className="lg:col-span-7">
          {selectedBatch ? (
            <div className="agri-card rounded-[32px] border border-[#ccd5ae]/40 shadow-soft p-6 sm:p-8 space-y-6">
              ...
              {/* Journey Timeline */}
              <div className="pt-2">
                <h3 className="text-xs font-bold uppercase tracking-wider text-[#01472e] mb-5">Batch Journey</h3>
                    ...
                    return (
                      <div key={step} className="flex items-start gap-4 pb-6 last:pb-0 relative">
                        ...
                        <div className="pt-1.5">
                          <p className={`text-xs font-bold ${isCompleted || isCurrent ? 'text-slate-900' : 'text-slate-400'}`}>{step}</p>
                          {isCurrent && (
                            <span className="text-[10px] text-[#01472e] bg-[#eaf4ec] border border-[#a3b18a]/50 px-2.5 py-0.5 rounded-full inline-block font-bold mt-1 shadow-2xs">Current Status</span>
                          )}
                        </div>
                      </div>
                    );
