...
export const NewsCard: React.FC<NewsCardProps> = ({ article, onClick }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-white rounded-xl border border-[#ccd5ae]/40 shadow-xs overflow-hidden hover:shadow-soft hover:border-[#a3b18a]/60 transition-all group cursor-pointer flex flex-col h-full text-left"
    >
      {article.imageUrl && (
